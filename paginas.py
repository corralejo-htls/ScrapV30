...
Instalación:
    ...
    -> en CMD instalar :
     ...
     -> en CMD (usos) a ejecutar : 
            python paginas.py
            Python paginas.py --solo-sql --ids=75888,75889,75891,75892,75899,75901
...
# (configurable; el estándar HTML sería "<br>" o "<br />").
HOTEL_DESC_BR = "</ br>"
        ...
        for rec in d.get("hotels", {}).values():
            for k in rec.keys():
                if k not in lang_cols:
                    lang_cols.append(k)
    header = top_cols + ["lang"] + lang_cols
    ...
    with open(out_path, "w", newline="", encoding="utf-8-sig") as f:
        ...
        for d in dats:
            ...
            for lang in orden:
                ...
                w.writerow(top_vals + [lang] + lang_vals)
                filas += 1
